...
public class Table<V> extends AbstractInteractableComponent<Table<V>> {
    ...
    public Table(String... columnLabels) {
        this(Attributes.EMPTY, columnLabels);
    }

    public Table(Attributes attributes, String... columnLabels) {
        super(attributes);
    ...
    public KeyStrokeResult onKeyStroke(KeyStroke keyStroke) {
        switch (keyStroke.getKeyType()) {
            ...
            case MouseEvent:
                ...
                if (isDifferentCell) {
                    return onKeyStroke(new KeyStroke(KeyType.Enter));
                }
                break;
            default:
                return super.onKeyStroke(keyStroke);
     ...
     *
     * @param clickListener Action to perform when user presses the enter or space key
     * @return Itself
     */
    public synchronized Table<V> setClickListener(ClickListener clickListener) {
