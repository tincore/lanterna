...
class DefaultTheme extends PropertyTheme {
    private static final String definition = "# This is the default properties\n" +
        ...
        "\n" +
        "# Menu\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.foreground[PRELIGHT] = red\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.background[PRELIGHT] = white\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.sgr[PRELIGHT] =\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.foreground[ACTIVE] = red\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.background[ACTIVE] = green\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.sgr[ACTIVE] =\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.foreground[SELECTED] = black\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.background[SELECTED] = green\n" +
        "com.googlecode.lanterna.gui2.menu.Menu.sgr[SELECTED] =\n" +
        "\n" +
        "# MenuItem\n" +
